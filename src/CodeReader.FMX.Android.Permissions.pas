unit CodeReader.FMX.Android.Permissions;
...
inherited;
FAutoRequest           := True;
FDisplayHeader         := 'O aplicativo precisa de permiss�es para:';
...
for I := 0 to FPermissionsList.Count-1 do
   ...
   Else
      ...
      If GetPropValue(FPermissionsRequest, FPermissionsList[I]) = True Then  //Comparado com true pq retorno � Variant
         Begin
